...
class WalletsComponent extends React.Component<Props, WalletsState> {
        ...
        if (wallets[selectedWalletIndex].type === 'coin') {
            return (
                <React.Fragment>
                    ...
                    <div className="pg-deposit-crypto-container">
            ...
            return (
                <React.Fragment>
                    <CurrencyInfo wallet={wallets[selectedWalletIndex]}/>
                    <div className="pg-depositfiat-container">
                        {currencyItem && currencyItem.deposit_enabled === false ? (
                            <Blur
    ...
    private renderWithdraw = () => {
        ...
        return (
            <React.Fragment>
                ...
                <div className="pg-withdraw-container">
    ...
    private renderWithdrawContent = () => {
        ...
        const withdrawProps: WithdrawProps = {
            ...
            withdrawAllButtonLabel: this.props.intl.formatMessage({ id: 'page.body.wallets.tabs.withdraw.content.button.withdrawall' }),
            wallet: wallet,
        };
